...
<h2 class="serif-heavy" style="color:var(--gold)">Se algum fizer sentido para o seu negócio, você pode começar a editar facilmente ao final da própria página do template.</h2></p>
<br><br>
""", unsafe_allow_html=True)
st.markdown("""
