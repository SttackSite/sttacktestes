...
<p style="color: var(--gold); font-family: 'Inter', sans-serif; font-size: 18px; margin-top: 20px;">Se fizer sentido pra você, comece a edição no final da página — rápido e fácil.</p>
<br><br>
""", unsafe_allow_html=True)
st.markdown("""
