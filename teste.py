...
st.markdown("""<h2>Navegue pelos modelos lateralmente e clique para ver cada <span class="serif-heavy"> template completo:</span></h2>
<p style="color: var(--gold); font-family: 'Inter', sans-serif; font-size: 18px; margin-top: 20px;">Se algum fizer sentido para o seu negócio, você pode começar a editar facilmente ao final da própria página do template.</p>
<br><br>
""", unsafe_allow_html=True)
st.markdown("""
